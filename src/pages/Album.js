            ...
            <div className='h-full pt-14 mx-4 md:mx-16'>
                <div className='py-2 md:py-8 h-full grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4'>
                    <div className='md:col-span-2 flex flex-col overflow-y-hidden'>
                        <div className='m-1 md:m-2 rounded-lg bg-appleMusicRed p-2 md:p-4 text-center flex flex-col justify-center'>
                            <h1 className='font-semibold text-sm md:text-xl'>Apple Music</h1>
                            <h4 className='text-xs md:text-lg'>Day of 17 Jan 2021</h4>
                        </div>
                        <div className='h-full px-2 flex flex-col'>
                            <input id='name' className='my-2 mx-auto w-full block bg-transparent border-2 border-text rounded-lg outline-none px-3 py-2 text-3xs md:text-2xs' type='text' placeholder='John Doe'></input>
